...
class FunctionRegistry {
  ...
  def getFunction2[T1, T2, T3](
    name: Symbol
  )(implicit ctt1: ClassTag[T1], ctt2: ClassTag[T2], ctt3: ClassTag[T2]): Option[(T1, T2) => Result[T3]] =
    functions2.get((getAliasedName(name), ctt1.runtimeClass, ctt2.runtimeClass, ctt3.runtimeClass)).asInstanceOf[Option[(T1, T2) => Result[T3]]]
  ...
  def registerReducer[T1, T2](
                                 name: Symbol,
                                 function: (T2, T1) => Result[T2],
                                 initial: T2
                               )(implicit ctt1: ClassTag[T1], ctt2: ClassTag[T2]): Unit =
    reducers((getAliasedName(name), ctt1.runtimeClass, ctt2.runtimeClass)) = (function, initial)

  def getReducer[T1, T2](name: Symbol)(implicit ctt1: ClassTag[T1], ctt2: ClassTag[T2]): Option[((T2, T1) => Result[T2], T2)] =
    reducers.get((getAliasedName(name), ctt1.runtimeClass, ctt2.runtimeClass)).asInstanceOf[Option[((T2, T1) => Result[T2], T2)]]
...
object FunctionRegistry {
  def createDefault: FunctionRegistry = {
    ...
    fr.registerFunction2[Double, Double, Double]('add,  (x, y) => Result.succ(x + y))
    fr.registerFunction2[Double, Double, Double]('sub,  (x, y) => Result.succ(x - y))
    fr.registerFunction2[Double, Double, Double]('mul,  (x, y) => Result.succ(x * y))
    fr.registerFunction2[Double, Double, Double]('div,  (x, y) => Result.succ(x / y))
    ...
    fr.registerFunction2[Boolean, Boolean, Boolean]('and,  (x, y) => Result.succ(x && y))
    fr.registerFunction2[Boolean, Boolean, Boolean]('or,  (x, y) => Result.succ(x || y))
    fr.registerFunction2[Boolean, Boolean, Boolean]('xor,  (x, y) => Result.succ(x ^ y))
