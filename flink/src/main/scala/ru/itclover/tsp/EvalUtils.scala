...
object EvalUtils {
  ...
  def composePhaseCodeUsingRowExtractors(phaseCode: String, tsField: Symbol, fieldsIdxMap: Map[Symbol, Int]) = {
    ...
    s"""
       ...
       |import ru.itclover.tsp.phases.BooleanPhases._
       |import ru.itclover.tsp.phases.ConstantPhases._
       |import ru.itclover.tsp.phases.MonadPhases._
       |import ru.itclover.tsp.phases.CombiningPhases._
       |import ru.itclover.tsp.aggregators.AggregatorPhases._
       |import ru.itclover.tsp.aggregators._
       |import ru.itclover.tsp.phases.Phases._
       |import ru.itclover.tsp.core.Time.{DoubleTimeLike, BigIntTimeLike}
       |
